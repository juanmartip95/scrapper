...
const main = async () => {
    ...
    await page.evaluate(() => {
        const buttons = Array.from(document.querySelectorAll('div[role="button"]')) as HTMLDivElement[];
    ...
    const extractedText = await page.evaluate(() => document.body.innerText) as string;
